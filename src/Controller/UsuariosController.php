...
class UsuariosController extends AbstractController
{
    ...
    /**
     * @Route("/{idUser}", name="usuarios_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idUser}/edit", name="usuarios_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{idUser}", name="usuarios_delete", methods={"DELETE"})
     */
    public function delete(Request $request, Usuarios $usuario): Response
    {
        if ($this->isCsrfTokenValid('delete'.$usuario->getIdUser(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
