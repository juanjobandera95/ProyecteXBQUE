 ...
 */
final class Version20200220130842 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE noticias ADD comentarios LONGTEXT NOT NULL, ADD user VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE noticias DROP comentarios, DROP user');
